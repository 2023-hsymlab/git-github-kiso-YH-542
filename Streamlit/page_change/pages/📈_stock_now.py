...
df_year = pd.read_csv('have_stocks.csv', index_col=0, encoding='shift_jis')
df_month = pd.read_csv('have_stocks.csv', index_col=0, nrows=22, encoding='shift_jis')
df_sixmonth = pd.read_csv('have_stocks.csv', index_col=0, nrows=127, encoding='shift_jis')
##取引日付
...
if day_judge == True:
    ...
    # print(today)
    # print(dif_day.days)
    df_exchange = pd.read_csv('have_stocks.csv', index_col=0, nrows= int(dif_day.days)+1, encoding='shift_jis')
